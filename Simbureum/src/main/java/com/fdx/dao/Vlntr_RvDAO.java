...
public interface Vlntr_RvDAO {
	...
	public void vlInsert(Vlntr_RvDTO vrdto) throws Exception; //자신이 심부름꾼일떄 리뷰  쓰기	
	...
	public PostRvDTO wrList(String mb_id_pk) throws Exception;// 자신이  심부름꾼일때 받은 리뷰 조회(전체)
