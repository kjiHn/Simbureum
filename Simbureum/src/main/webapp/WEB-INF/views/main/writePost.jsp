...
<body>
	...
	<div class="col-lg-11 posts-list" id="centerCon">
		...
		<form method="POST" action="writePost" id="writeForm">
			<table class="postTable">
				...
				<tr>
					<th>심부름꾼 수 : </th>
					<td><input name="post_numof" class="textinput" id="numof" placeholder="심부름꾼 수 입력(최대 9명)" /></td>
				</tr>
				<tr>
					<th>심부름 가격 : </th>
	...
	<script>
		...
		var options = {
			center: new kakao.maps.LatLng(37.474363876512, 127.03086981156734),
			level: 5
		};
		...
		// 마커가 표시될 위치입니다 
		var markerPosition  = new kakao.maps.LatLng(37.474363876512, 127.03086981156734); 
